    ...
    this._messages.forEach((message, index) => {
      ...
      if (messageType !== 'string') {
        ...
        if (messageItem.role === 'assistant') {
            messageItem.message = message.content.message || '';
            messageItem.thinking = message.content.thinking || '';
            messageItem.final_answer = message.content.final_answer || '';
        ...
        // Mark the latest assistant message for streaming updates
          ...
          messageItem.content = message.content[0].text;
