class MessageInput extends HTMLElement {
  ...
  handleChangeModelButtonClick() {
    // create a custom event to handle model change
    console.log('MessageInput: handleChangeModelButtonClick called');
    const event = new CustomEvent('change-model', {
      bubbles: true,
      composed: true, // Allow event to cross Shadow DOM boundaries
      detail: {}
    });
    console.log('MessageInput: Dispatching change-model event');
    const dispatched = this.dispatchEvent(event);
    // console.log('MessageInput: Event dispatched successfully:', dispatched);
  }
